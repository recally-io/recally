...
const docTemplate = `{
        ...
        "/auth/user/info": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "User info update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpserver.updateUserInfoRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpserver.updateUserPasswordRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpserver.updateUserSettingsRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/auth.ApiKeyDTO"
                                            }
                                        }
                                    }
                                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpserver.createApiKeyRequest"
                        }
                    }
                ],
                "responses": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/tools.BaseTool"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "httpserver.createApiKeyRequest": {
            "type": "object",
            "required": [
                "expires_at",
                "name"
        ...
        "httpserver.updateUserInfoRequest": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "httpserver.updateUserPasswordRequest": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "httpserver.updateUserSettingsRequest": {
            "type": "object",
            "required": [
                "id"
            ],
