...
const SearchToken: React.FC<SearchTokenProps> = ({
	...
	<span className="inline-flex items-center gap-1 px-2 py-1 text-sm bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 rounded-md">
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			<PopoverTrigger asChild>
				<Button
					variant="ghost"
					className="h-7 px-2 gap-1 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 text-sm"
				>
					{label}
			...
			<div className="w-full space-y-2">
				...
				<div className="flex flex-col gap-1">
					<div className="flex justify-between items-center gap-2">
						<div className="relative flex items-center gap-2 w-full border dark:border-gray-700 rounded-md pl-3 pr-2 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500 dark:bg-gray-900">
							<Search className="h-4 w-4 text-gray-400 dark:text-gray-500 flex-shrink-0" />
							<div className="flex flex-wrap gap-1 flex-1 py-1.5 max-h-20 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent">
								...
								<div className="flex-1 min-w-[150px] flex items-center gap-2">
									<input
										className="w-full outline-none text-sm py-0.5 bg-transparent dark:text-gray-200"
