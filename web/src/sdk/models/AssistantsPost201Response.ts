 ...
 */
export function instanceOfAssistantsPost201Response(value: object): value is AssistantsPost201Response {
    return true;
}

export function AssistantsPost201ResponseFromJSON(json: any): AssistantsPost201Response {
    return AssistantsPost201ResponseFromJSONTyped(json, false);
}

export function AssistantsPost201ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AssistantsPost201Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : AssistantsAssistantDTOFromJSON(json['data']),
...
export function AssistantsPost201ResponseToJSON(value?: AssistantsPost201Response | null): any {
    if (value == null) {
        return value;
    }
    return {
