 ...
 */
export function instanceOfToolsWebSummaryGet200Response(value: object): value is ToolsWebSummaryGet200Response {
    return true;
}

export function ToolsWebSummaryGet200ResponseFromJSON(json: any): ToolsWebSummaryGet200Response {
    return ToolsWebSummaryGet200ResponseFromJSONTyped(json, false);
}

export function ToolsWebSummaryGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolsWebSummaryGet200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ToolsWebSummaryGet200ResponseToJSON(value?: ToolsWebSummaryGet200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
