 ...
 */
export function instanceOfHttpserverJSONResult(value: object): value is HttpserverJSONResult {
    return true;
}
...
export function HttpserverJSONResultFromJSONTyped(json: any, ignoreDiscriminator: boolean): HttpserverJSONResult {
    if (json == null) {
        return json;
    }
    return {
...
export function HttpserverJSONResultToJSON(value?: HttpserverJSONResult | null): any {
    if (value == null) {
        return value;
    }
    return {
