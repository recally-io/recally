 ...
 */
export function instanceOfJinasearcherContent(
  value: object,
): value is JinasearcherContent {
  return true;
}
...
export function JinasearcherContentFromJSONTyped(
  json: any,
...
export function JinasearcherContentToJSON(
  value?: JinasearcherContent | null,
): any {
  if (value == null) {
    return value;
  }
