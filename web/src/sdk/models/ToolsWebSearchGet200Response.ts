 ...
 */
export function instanceOfToolsWebSearchGet200Response(value: object): value is ToolsWebSearchGet200Response {
    return true;
}

export function ToolsWebSearchGet200ResponseFromJSON(json: any): ToolsWebSearchGet200Response {
    return ToolsWebSearchGet200ResponseFromJSONTyped(json, false);
}

export function ToolsWebSearchGet200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ToolsWebSearchGet200Response {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : JinasearcherContentFromJSON(json['data']),
...
export function ToolsWebSearchGet200ResponseToJSON(value?: ToolsWebSearchGet200Response | null): any {
    if (value == null) {
        return value;
    }
    return {
