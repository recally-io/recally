...
SELECT u.id, u.uuid, u.username, u.password_hash, u.email, u.phone, u.activate_assistant_id, u.activate_thread_id, u.status, u.settings, u.created_at, u.updated_at FROM users u 
