...
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users WHERE email = $1
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users WHERE uuid = $1
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users 
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users WHERE phone = $1
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users WHERE username = $1
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users ORDER BY created_at DESC
`
...
SELECT id, uuid, username, password_hash, email, phone, status, settings, created_at, updated_at FROM users WHERE status = $1 ORDER BY created_at DESC
`
