// Port from https://github.com/dusted-go/logging/blob/main/prettylog/prettylog.go
...
func NewColorHandler(handlerOptions *slog.HandlerOptions, options ...Option) *Handler {
