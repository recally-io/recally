...
// database/migrations/000008_comprehensive_bookmarks.down.sql
...
func _000007_new_auth_flowsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000007_new_auth_flows.down.sql", size: 1225, mode: os.FileMode(420), modTime: time.Unix(1733886327, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func _000007_new_auth_flowsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "000007_new_auth_flows.up.sql", size: 6277, mode: os.FileMode(420), modTime: time.Unix(1733886327, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
